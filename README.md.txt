...
Method: GET, POST, PUT, DELETE response code: 200, 201, 300, 401, 404, 500
...
Page Objects Modeling (design pattern) using classes, objects, inheritence, encapsulation
Pytest - unit testing framework
to generate Pass/Fail status, generate reportsass/Fail status, generate reports rate reports